...
class Personalausweis {
	...
	class persoOrt {
		...
		class 32892 {
			...
			plz = 32892;
			str[] = {{"Main road",30},{"Palmenarm",12},{"Zum Mischwalde",6}};
		};	
		class 35557 {
			id = 4;
			name = "Alikampos";
		...
		class 37690 {
			...
			name = "Kavala";
			plz = 37690;
			str[] = {{"Burgblick",4},{"Main road",25},{"Am Krankenhaus",9},{"Palmenweg",8},{"Ruhrstrasse",6}};
		};	
		class 38212 {
			id = 18;
			name = "Kore";
		...
		class 38023 {
			...
			name = "Lakka";
			plz = 38023;
			str[] = {{"Main road",3},{"Fliegerwiese",4}};
		};	
		class 35026 {
			id = 20;
			name = "Molos";
		...
		class 30854 {
			...
			name = "Neochori";
			plz = 30854;
			str[] = {{"At the Foreste",12},{"Am Markt",4},{"Hafenstrasse",3},{"Fischerweg",2},{"Gradestrasse",5},{"Feldstrasse",4}};
		};	
		class 39394 {
			id = 23;
			name = "Neri";
		...
		class 37708 {
			...
			name = "Paros";
			plz = 37708;
			str[] = {{"Main road",21},{"Astweg",6},{"Zweigstrasse",1},{"Kaeufermarkt",4},{"Zum Unterstand",6}};
		};	
		class 35182 {
			id = 28;
			name = "Poliakko";
		...
		class 36893 {
			...
			name = "Pyrgos";
			plz = 36893;
			str[] = {{"Main road",12},{"Kanalweg",8},{"Muehlenstrasse",5},{"Island route",4},{"Rock festival",4},{"Weinsberg meadow",8}};
		};	
		class 36602 {
			name = "Rodopoli";
			plz = 36602;
			str[] = {{"At two mills",4},{"Main road",5},{"Kuester Road",4}};
		};	
		class 30081 {
			id = 30;
			name = "Sofia";
			plz = 30081;
			str[] = {{"Main road",16},{"At the sports field",6},{"Radar Road",7},{"Langensberg",6}};
		};	
		class 34301 {
			id = 31;
			name = "Stavros";
			plz = 34301;
			str[] = {{"On the needle",12},{"In the coniferous forest",4},{"Agia Marina Road",4}};
		};	
		class 37083 {
			id = 32;
			name = "Syrta";
			plz = 37083;
			str[] = {{"Girna road",11},{"Miller",2}};
		};	
		class 31535 {
			id = 33;
			name = "Telos";
			plz = 31535;
			str[] = {{"Four wheel",14},{"Main road",3},{"Financial route",5}};
		};	
		class 35427 {
			id = 34;
			name = "Therisa";
			plz = 35427;
			str[] = {{"Sonnenweg",6},{"On the field",3}};
		};	
		class 38255 {
			id = 35;
			name = "Topolia";
		...
		class 31167 {
			...
			name = "Zaros";
			plz = 31167;
			str[] = {{"Religious",12},{"At the sports field",6},{"Main Street",8},{"At the Forest",4}};
		};	
	};
